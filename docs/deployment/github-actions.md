...
O endereço da VPS, o usuário `root` e o fingerprint SSH ficam versionados no workflow. Para publicar e fazer pull da imagem no GHCR, o workflow usa o `GITHUB_TOKEN` temporário fornecido automaticamente pelo GitHub; não há token GHCR adicional.
